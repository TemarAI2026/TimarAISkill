...
**Goal:** Add the first-phase `docs/mcp` public documentation skeleton and expose it as the MCP-first public entrypoint in `TemarAISkill`.
...
Run: `Select-String -Path 'E:\项目\TemarAISkill\TemarAISkill\docs\mcp\README*.md' -Pattern '^# |^## '`
...
Run: `Select-String -Path 'E:\项目\TemarAISkill\TemarAISkill\docs\mcp\overview\*.md' -Pattern '^# |^## '`
...
Run: `Select-String -Path 'E:\项目\TemarAISkill\TemarAISkill\docs\mcp\capabilities\*.md' -Pattern '^# |^## '`
...
Run: `Select-String -Path 'E:\项目\TemarAISkill\TemarAISkill\docs\mcp\references\*.md' -Pattern '^# |^## '`
...
Run: `rg -n "TODO|TBD|placeholder|later|fill in" 'E:\项目\TemarAISkill\TemarAISkill\docs\mcp'`
Expected: no unfinished-content markers in the new MCP docs.

- [ ] **Step 2: Run a repository structure check**

Run: `Get-ChildItem -Recurse -File 'E:\项目\TemarAISkill\TemarAISkill\docs\mcp' | Select-Object FullName`
Expected: the MCP README, overview, capabilities, and references files all exist.

- [ ] **Step 3: Stage the MCP documentation changes**

```bash
git -C 'E:\项目\TemarAISkill\TemarAISkill' add README.md docs/repository-map.md docs/mcp docs/plans/2026-05-25-mcp-public-documentation-skeleton-implementation-plan.md
```

- [ ] **Step 4: Commit the MCP documentation skeleton**

```bash
git -C 'E:\项目\TemarAISkill\TemarAISkill' commit -m "docs: add mcp public documentation skeleton"
```
